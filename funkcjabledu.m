...
if (length(x) ~= length(x_odn)),error('x1 musi byæ dlugosci takiej jak x2!'); end
if (length(y) ~= length(y_odn)),error('y1 musi byæ dlugosci takiej jak y2!'); end
if (length(u) ~= length(u_odn)),error('u1 musi byæ dlugosci takiej jak u2!'); end
